...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.educations.school')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.educations.specialized')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.started_at')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.ended_at')); ?>
...
<?php $component->withAttributes(['class' => 'text-end']); ?>
            <?php echo e(trans('plugins/job-board::account.table.action')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['scope' => 'row']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['scope' => 'row']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($education->specialized); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($education->started_at->format('Y-m-d')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($education->ended_at ? $education->ended_at->format('Y-m-d') : trans('plugins/job-board::account.now')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>
                    <span data-bs-toggle="tooltip" title="<?php echo e(trans('plugins/job-board::account.action_table.edit')); ?>">
                        <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','color' => 'primary','size' => 'sm','dataBsToggle' => 'modal','dataBsTarget' => '#edit-account-entity-modal','dataModalTitle' => trans('plugins/job-board::account.edit_education'),'dataTable' => '#educations-table','href' => route('accounts.educations.edit-modal', [$education->id, $education->account_id]),'icon' => 'ti ti-edit','iconOnly' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','color' => 'primary','size' => 'sm','data-bs-toggle' => 'modal','data-bs-target' => '#edit-account-entity-modal','data-modal-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/job-board::account.edit_education')),'data-table' => '#educations-table','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('accounts.educations.edit-modal', [$education->id, $education->account_id])),'icon' => 'ti ti-edit','icon-only' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','dataBsToggle' => 'modal','dataBsTarget' => '#modal-confirm-delete','color' => 'danger','size' => 'sm','href' => route('accounts.educations.destroy', $education->id),'dataTable' => '#educations-table','dataBsOriginalTitle' => ''.e(trans('plugins/job-board::account.action_table.delete')).'','icon' => 'ti ti-trash','iconOnly' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','data-bs-toggle' => 'modal','data-bs-target' => '#modal-confirm-delete','color' => 'danger','size' => 'sm','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('accounts.educations.destroy', $education->id)),'data-table' => '#educations-table','data-bs-original-title' => ''.e(trans('plugins/job-board::account.action_table.delete')).'','icon' => 'ti ti-trash','icon-only' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal922f7d3260a518f4cf606eecf9669dcb)): ?>
<?php $attributes = $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb; ?>
...
<?php $component->withAttributes([]); ?>
                <?php if (isset($component)) { $__componentOriginal39a228eaec73c356bdf14858f816ca38 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal39a228eaec73c356bdf14858f816ca38 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.body.cell','data' => ['colspan' => '6','class' => 'text-center text-muted']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::table.body.cell'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => '6','class' => 'text-center text-muted']); ?>
                    <?php echo e(trans('plugins/job-board::account.no_education')); ?>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/plugins/job-board/resources/views/accounts/educations.blade.php ENDPATH**/ ?>