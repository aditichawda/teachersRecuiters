...
<style>
    ...
    <?php
        ...
        $useLocationDropdowns = is_plugin_active('location') && count($countries) > 0;
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="city-search-wrapper" style="position:relative;">
                        <input type="text" id="js-current-city-search" class="form-control" value="<?php echo e($currentCityName); ?>" placeholder="<?php echo e(__('Type city name...')); ?>" autocomplete="off">
