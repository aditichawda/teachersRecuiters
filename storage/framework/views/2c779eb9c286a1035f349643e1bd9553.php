    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        resendBtn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.error === false) {
                    <?php if(!empty($isWhatsappAvailable) && !empty($phone)): ?>
                        alert('Verification code resent successfully to your WhatsApp (<?php echo e($phone); ?>) and Email (<?php echo e($email); ?>)!');
                    <?php else: ?>
                        alert('Verification code resent successfully to your Email (<?php echo e($email); ?>)!');
                    <?php endif; ?>
                    startTimer();
                } else {
