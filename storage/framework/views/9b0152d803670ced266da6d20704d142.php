...
<section class="for-schools-section">
    <div class="container">
        ...
        <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
            <?php $topAds = render_page_ads('for-schools', 'top'); ?>
            <?php if(!empty($topAds)): ?>
        ...
        <div class="schools-hero">
            <div class="schools-hero-content">
                ...
                <div class="hero-cta">
                    <a href="<?php echo e(route('public.account.register')); ?>" class="btn-primary-custom">Register Your School</a>
                    <a href="<?php echo e(JobBoardHelper::getJobcompaniesPageURL()); ?>" class="btn-outline-custom">View Schools</a>
                </div>
            </div>
        ...
        <div class="schools-cta">
            <div class="cta-content">
                ...
                <div class="cta-buttons">
                    <a href="<?php echo e(route('public.account.register')); ?>" class="btn-primary-custom">Register Your School Now</a>
                    <a href="<?php echo e(JobBoardHelper::getJobsPageURL()); ?>" class="btn-outline-custom">View Job Postings</a>
                </div>
            </div>
        ...
        <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
            <?php $bottomAds = render_page_ads('for-schools', 'bottom'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/for-schools.blade.php ENDPATH**/ ?>