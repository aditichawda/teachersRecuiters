        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="hiw-hero-image">
                    <img src="<?php echo e(Theme::asset()->url('images/gir-large.png')); ?>" alt="Teaching Career" class="img-fluid rounded-4">
                </div>
            </div>
        </div>
    </div>
...
<section class="hiw-alternating-section">
    <div class="container">
        ...
        <div class="row align-items-center hiw-alt-row">
            <div class="col-lg-6">
                <div class="hiw-alt-image">
                    <img src="<?php echo e(Theme::asset()->url('images/gir-large-2.png')); ?>" alt="For Teachers" class="img-fluid rounded-4">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="hiw-alt-content">
                    ...
                    <a href="<?php echo e(route('public.account.register')); ?>" class="hiw-btn-primary">Register as Teacher</a>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center hiw-alt-row flex-lg-row-reverse">
            <div class="col-lg-6">
                <div class="hiw-alt-image">
                    <img src="<?php echo e(Theme::asset()->url('images/boy-large.png')); ?>" alt="For Schools" class="img-fluid rounded-4">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="hiw-alt-content">
                    ...
                    <a href="<?php echo e(route('public.account.register')); ?>" class="hiw-btn-primary">Register as School</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="hiw-cta-content">
            ...
            <div class="hiw-cta-buttons">
                <a href="<?php echo e(route('public.account.register')); ?>" class="hiw-btn-white">Get Started Free</a>
                <a href="/jobs" class="hiw-btn-outline">View Jobs</a>
            </div>
        </div>
    </div>
</section><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/partials/how-it-works-layout.blade.php ENDPATH**/ ?>