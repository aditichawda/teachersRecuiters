...
<?php if($showField): ?>
    <?php echo Form::customEditor($name, $options['value'], $options['attr']); ?>
...
<?php if($showLabel && $showField): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/plugins/job-board/resources/views/themes/dashboard/forms/fields/custom-editor.blade.php ENDPATH**/ ?>