...
.jobs-top-filter .filter-group .keyword-input-wrapper input[type="text"],
.jobs-top-filter .filter-group .location-input-wrapper input[type="text"] {
    padding-left: 48px;
}
...
.search-btn {
    ...
    box-shadow: 0 4px 16px rgba(0, 115, 209, 0.4), 0 2px 8px rgba(0, 115, 209, 0.25);
    text-transform: uppercase;
...
.search-btn:hover {
    ...
    box-shadow: 0 8px 24px rgba(0, 115, 209, 0.5), 0 4px 12px rgba(0, 115, 209, 0.3);
}
.search-btn:active {
        ...
        <form action="<?php echo e(JobBoardHelper::getJobsPageURL()); ?>" method="get" id="jobs-top-filter-form" class="jobs-top-filter">
            ...
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <div class="keyword-input-wrapper" style="position: relative;">
                        <i class="feather-briefcase" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #0073d1; font-size: 18px; z-index: 2; pointer-events: none;"></i>
                        <input type="text" id="home_category_search" name="keyword" value="<?php echo e(BaseHelper::stringify(request()->query('keyword'))); ?>" placeholder="<?php echo e(__('Type to search...')); ?>" autocomplete="off" class="wt-search-bar-select" style="padding-left: 48px;">
                        <input type="hidden" id="home_keyword_id" name="job_categories[]" value="<?php echo e(BaseHelper::stringify(request()->query('job_categories.0'))); ?>">
                ...
                <div class="filter-group">
                    ...
                    <div class="location-input-wrapper" style="position: relative;">
                        <i class="feather-map-pin" style="position: absolute; left: 16px; top: 50%; transform: translateY(-50%); color: #0073d1; font-size: 18px; z-index: 2; pointer-events: none;"></i>
                        <input type="text" name="city_search" id="home_city_search" class="wt-search-bar-select home-city-search-input" placeholder="<?php echo e(__('Select Your Location')); ?>" autocomplete="off" value="<?php echo e(request('city_search', BaseHelper::stringify(request()->query('location')))); ?>" style="padding-left: 48px;" />
                        <input type="hidden" name="city_id" id="home_city_id" value="<?php echo e(request('city_id', BaseHelper::stringify(request()->query('city_id')))); ?>" />
            ...
            <div class="col-lg-9 col-md-12 position-relative">
                <div class="product-filter-wrap d-flex justify-content-between align-items-center m-b30">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <span class="woocommerce-result-count-left" style="font-size: 15px; font-weight: 600; color: #475569; padding: 10px 16px; background: #f8fafc; border-radius: 10px; border: 1px solid #e2e8f0;">
                        <?php if($jobs->total()): ?>
