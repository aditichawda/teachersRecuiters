        ...
        <div class="modal-content signup-login-modal-content border-0 shadow-lg rounded-3 overflow-hidden">
            <div class="signup-login-card-row">
                ...
                <div class="modal-body px-4 pb-4 pt-2">
                    <p class="signup-login-desc text-center mb-4"><?php echo e(__('Create your profile or login to apply for jobs and start hiring')); ?></p>
                    ...
                    <p class="text-center small mb-0">
                        <a href="<?php echo e($loginUrl); ?>" class="signup-login-login-link"><?php echo e(__('Login')); ?> <svg class="d-inline-block ms-1" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
                    </p>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/partials/signup-login-modal.blade.php ENDPATH**/ ?>