...
<div class="form-group mb-4">
    <h4 class="section-head-small mb-4"><?php echo e(__('Institute Name')); ?></h4>
    <select name="company_id" class="wt-select-bar-large selectpicker" data-live-search="true" data-size="8">
        <option value=""><?php echo e(__('All Institutes')); ?></option>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/partials/jobs/filters/institute-name.blade.php ENDPATH**/ ?>