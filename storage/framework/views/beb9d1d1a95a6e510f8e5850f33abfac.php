...
<section class="premium-service-section">
    <div class="container">
        ...
        <div class="premium-pricing">
            <h2>
                <?php if(($employerPackageLabel ?? null) === 'consultancy'): ?>
                    <?php echo e(__('Consultancy Plans')); ?>

                <?php elseif(($employerPackageLabel ?? null) === 'school_institution'): ?>
                    <?php echo e(__('School / Institution Plans')); ?>
...
<script>
    (function () {
        const packageType = <?php echo json_encode($packageType ?? null, 15, 512) ?>;
        const employerPackageLabel = <?php echo json_encode($employerPackageLabel ?? null, 15, 512) ?>;
        const premiumDebug = <?php echo json_encode($premiumDebug ?? null, 15, 512) ?>;
        const packagesCount = <?php echo json_encode(isset($packages) ? $packages->count() : 0, 15, 512) ?>;
        const packageIds = <?php echo json_encode(isset($packages) ? $packages->pluck('id')->values() : [], 15, 512) ?>;
