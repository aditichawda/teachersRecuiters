    ...
    <div class="candidates-content">
        ...
        <?php else: ?>
            <div class="text-center py-5" style="padding: 60px 20px;">
                ...
                <h3 style="color: #1e293b; font-size: 24px; font-weight: 600; margin-bottom: 12px;"><?php echo e(__('No Candidates Found')); ?></h3>
                <p style="color: #64748b; font-size: 16px; margin-bottom: 0;"><?php echo e(__('No candidate profiles are available right now.')); ?></p>
            </div>
        <?php endif; ?>

        <?php if($hasCandidates && $candidates instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
            <div class="row">
