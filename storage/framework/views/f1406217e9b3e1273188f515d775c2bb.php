            ...
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <div class="home-category-search-wrapper" style="position: relative;">
                        <input type="text" id="home_category_search" name="keyword" value="<?php echo e(BaseHelper::stringify(request()->query('keyword'))); ?>" placeholder="<?php echo e(__('Type to search...')); ?>" autocomplete="off" class="wt-search-bar-select">
                ...
                <div class="filter-group">
                    ...
                    <div class="home-city-search-wrapper" style="position: relative;">
                        <input type="text" name="city_search" id="home_city_search" class="wt-search-bar-select home-city-search-input" placeholder="<?php echo e(__('Select Your Location')); ?>" autocomplete="off" value="<?php echo e(request('city_search', BaseHelper::stringify(request()->query('location')))); ?>" />
...
<?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/partials/shortcodes/jobs/index.blade.php ENDPATH**/ ?>