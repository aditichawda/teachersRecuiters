        ...
        <form action="<?php echo e(JobBoardHelper::getJobsPageURL()); ?>" method="get" id="jobs-top-filter-form" class="jobs-top-filter">
            ...
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <select name="job_categories[]" class="selectpicker" data-live-search="true" data-size="8" title="<?php echo e(__('Select Job Role')); ?>">
                        <option value=""><?php echo e(__('All Job Roles')); ?></option>
                    ...
                    <!-- <input type="text" name="keyword" value="<?php echo e(BaseHelper::stringify(request()->query('keyword'))); ?>" placeholder="<?php echo e(__('Or Enter Teaching Subject or Post')); ?>" class="keyword-input-below"> -->
                </div>
