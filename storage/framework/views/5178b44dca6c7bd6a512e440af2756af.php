...
<div class="jd-main">
    <div class="container">
        ...
        <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
            <?php $topAds = render_page_ads('job-detail', 'top'); ?>
            <?php if(!empty($topAds)): ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="jd-share">
                    ...
                    <div class="jd-share-buttons">
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode($job->url)); ?>" target="_blank" rel="noopener" class="jd-share-btn facebook" title="Share on Facebook">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode($job->url)); ?>&text=<?php echo e(urlencode($job->name)); ?>" target="_blank" rel="noopener" class="jd-share-btn twitter" title="Share on Twitter">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode($job->url)); ?>&title=<?php echo e(urlencode($job->name)); ?>" target="_blank" rel="noopener" class="jd-share-btn linkedin" title="Share on LinkedIn">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($job->name . ' ' . $job->url)); ?>" target="_blank" rel="noopener" class="jd-share-btn whatsapp" title="Share on WhatsApp">
                            <i class="fab fa-whatsapp"></i>
                        </a>
                        <a href="javascript:void(0);" onclick="navigator.clipboard.writeText('<?php echo e($job->url); ?>');this.title='Copied!';setTimeout(()=>this.title='Copy Link',2000);" class="jd-share-btn copy-link" title="Copy Link">
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
                    <?php $sidebarTopAds = render_page_ads('job-detail', 'sidebar-top'); ?>
                    <?php if(!empty($sidebarTopAds)): ?>
                        <div class="jd-sidebar-card" style="margin-bottom: 20px;">
                            <?php echo $sidebarTopAds; ?>
                ...
                <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
                    <?php $sidebarMiddleAds = render_page_ads('job-detail', 'sidebar-middle'); ?>
                    <?php if(!empty($sidebarMiddleAds)): ?>
                        <div class="jd-sidebar-card" style="margin-top: 20px;">
                            <?php echo $sidebarMiddleAds; ?>
                ...
                <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
                    <?php $sidebarBottomAds = render_page_ads('job-detail', 'sidebar-bottom'); ?>
                    <?php if(!empty($sidebarBottomAds)): ?>
                        <div class="jd-sidebar-card" style="margin-top: 20px;">
                            <?php echo $sidebarBottomAds; ?>
                ...
                <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
                    <?php $sidebarAds = render_page_ads('job-detail', 'sidebar-right'); ?>
        ...
        <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
            <?php $bottomAds = render_page_ads('job-detail', 'bottom'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/job-v1.blade.php ENDPATH**/ ?>