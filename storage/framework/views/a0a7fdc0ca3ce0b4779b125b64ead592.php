            ...
            <?php if(is_plugin_active('location')): ?>
                <div class="form-group col-xl-4 col-lg-5 col-md-6">
                    ...
                    <div class="home-city-search-wrapper" style="position: relative;">
                        <input type="text" name="city_search" id="home_city_search" class="wt-search-bar-select home-city-search-input" placeholder="<?php echo e(__('Select Your Location')); ?>" autocomplete="off" value="<?php echo e(request('city_search', '')); ?>" />
                        <input type="hidden" name="city_id" id="home_city_id" value="<?php echo e(request('city_id', '')); ?>" />
