        ...
        <div class="enl-header-right" style="display: flex; align-items: center; gap: 20px;">
            ...
            <div class="enl-header-user">
                ...
                <div class="enl-header-dropdown" id="jsUserDropdown">
                    <a href="<?php echo e(route('public.account.jobseeker.dashboard')); ?>"><i class="fa fa-home"></i> Dashboard</a>
                    ...
                    <hr>
                    <a href="<?php echo e(route('public.account.logout')); ?>" id="logout-link-js" onclick="event.preventDefault(); handleLogoutClick(event);"><i class="fa fa-sign-out-alt"></i> Logout</a>
                </div>
            </div>
        </div>
    </div>
...
<form id="logout-form-js" style="display:none;" action="<?php echo e(route('public.account.logout')); ?>" method="POST"><?php echo csrf_field(); ?></form>
