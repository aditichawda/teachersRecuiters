...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('invoice.generate-invoice', ['id' => $invoice->id, 'type' => 'print']),'target' => '_blank','icon' => 'ti ti-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('invoice.generate-invoice', ['id' => $invoice->id, 'type' => 'print'])),'target' => '_blank','icon' => 'ti ti-printer']); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('invoice.generate-invoice', ['id' => $invoice->id, 'type' => 'download']),'target' => '_blank','icon' => 'ti ti-download']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('invoice.generate-invoice', ['id' => $invoice->id, 'type' => 'download'])),'target' => '_blank','icon' => 'ti ti-download']); ?>
...
<?php $component->withAttributes(['class' => 'text-center','style' => 'width: 25%']); ?>
                                <?php echo e(format_price($item->amount, $currency)); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <?php echo e(format_price($invoice->sub_total, $currency)); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <?php echo e(format_price($invoice->tax_amount, $currency)); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <?php echo e(format_price($invoice->shipping_amount, $currency)); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                                <span><?php echo e(format_price($invoice->discount_amount, $currency)); ?></span>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>
                            <?php echo e(format_price($invoice->amount, $currency)); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aditi\platform\plugins\job-board\/resources/views/invoice/edit.blade.php ENDPATH**/ ?>