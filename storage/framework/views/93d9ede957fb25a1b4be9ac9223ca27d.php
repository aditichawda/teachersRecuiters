    ...
    <div class="location-container">
        ...
        <div class="location-body">
            ...
            <form id="location-form" onsubmit="return false;">
                ...
                <!-- Back Link -->
                <div class="back-link">
                    <a href="<?php echo e(route('public.account.register.institutionTypePage')); ?>">Back</a>
                </div>
            </form>
        </div>
    </div>
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // Load email from API
        $.ajax({
            url: '<?php echo e(route("public.account.register.getVerificationData")); ?>',
            type: 'GET',
        ...
        function loadIndiaCities(page, append) {
            ...
            if (!append) {
                ...
                $('#city-load-more').text('Loading...').css('pointer-events', 'none');
            }
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#city-load-more').remove();
                    if (hasMore) {
                        $suggestions.append('<div class="city-load-more" id="city-load-more">Load more (10 more)</div>');
                    }
                },
                error: function() {
                    if (!append) $suggestions.html('<div class="city-no-results">Error loading cities</div>');
                    else $('#city-load-more').text('Load more (10 more)').css('pointer-events', 'auto');
                }
            });
        }

        // On focus/click: when empty, show India cities by default (page 1)
        ...
        $(document).on('click', '#city-load-more', function() {
            const $suggestions = $('#city-suggestions');
        ...
        $('#submit-btn').on('click', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("public.account.register.saveLocation")); ?>',
                type: 'POST',
                headers: {
                ...
                success: function(data) {
                    ...
                    window.location.href = '<?php echo e(route("public.account.jobseeker.dashboard")); ?>';
                },
                error: function(xhr) {
...
<?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/views/job-board/auth/location.blade.php ENDPATH**/ ?>