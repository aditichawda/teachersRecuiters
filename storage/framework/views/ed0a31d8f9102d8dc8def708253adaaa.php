<?php $__env->startSection('content'); ?>
    <div class="row row-cols-1 row-cols-lg-3 mb-3 row-cards">
        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['card card-md box-package h-100', 'active' => $package->is_default]); ?>">
                    <?php if($package->percent_save): ?>
                        <div class="ribbon ribbon-top ribbon-bookmark bg-green">
                            <?php echo e($package->percent_save_text); ?>

                            <span class="sr-only"><?php echo e(trans('plugins/job-board::dashboard.save')); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="card-body">
                        <?php if($package->price): ?>
                            <div class="box-package-price d-flex align-items-end">
                                <h4><?php echo e($package->price_text); ?></h4><span class="text-muted">/<?php echo e($package->number_of_listings); ?> <?php echo e(trans('plugins/job-board::dashboard.posts_count')); ?></span>
                            </div>
                        <?php else: ?>
                            <div class="box-package-price">
                                <h4><?php echo e(trans('plugins/job-board::dashboard.free_label')); ?></h4>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($features = $package->formatted_features): ?>
                            <p class="small text-muted mb-1"><?php echo e(trans('plugins/job-board::dashboard.package_includes')); ?>:</p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['type' => 'submit','class' => 'w-100','color' => ''.e($package->is_default ? 'success' : null).'','disabled' => $package->isPurchased()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-100','color' => ''.e($package->is_default ? 'success' : null).'','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($package->isPurchased())]); ?>
                                    <?php echo e($package->isPurchased() ? trans('plugins/job-board::dashboard.purchased_label') : trans('plugins/job-board::dashboard.purchase')); ?>
...
<?php endif; ?>
    ...
    <?php if(auth('account')->user()->transactions()->exists()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(trans('plugins/job-board::dashboard.transactions_title')); ?>
...
<?php endif; ?>
            <payment-history-component
                url="<?php echo e(route('public.account.ajax.transactions')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::loading','data' => ['vIf' => 'isLoading']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['v-if' => 'isLoading']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <p class="empty-title">
                            <?php echo e(trans('plugins/job-board::dashboard.oops')); ?>

                        </p>
                        <p class="empty-subtitle text-muted">
                            <?php echo e(trans('plugins/job-board::dashboard.no_transactions')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.footer.index','data' => ['vIf' => 'data.links.next']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['v-if' => 'data.links.next']); ?>
                        <a href="javascript:void(0)" v-if="!isLoadingMore" @click="getData(data.links.next)">
                            <?php echo e(trans('plugins/job-board::dashboard.load_more')); ?>

                        </a>
                        <a href="javascript:void(0)" v-if="isLoadingMore">
                            <?php echo e(trans('plugins/job-board::dashboard.loading_more')); ?>
...
<?php echo $__env->make(JobBoardHelper::viewPath('dashboard.layouts.master'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/plugins/job-board/resources/views/themes/dashboard/packages.blade.php ENDPATH**/ ?>