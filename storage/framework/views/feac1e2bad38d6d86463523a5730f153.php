    ...
    <div class="verify-container">
        ...
        <div class="verify-body">
            ...
            <?php if(!empty($isWhatsappAvailable) && !empty($phone)): ?>
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 12px 16px; margin-bottom: 18px; text-align: center;">
                    <p style="margin: 0; color: #555; font-size: 13px;">
                        Verification code sent to: <i class="ti ti-brand-whatsapp" style="color: #25D366; font-size: 15px; vertical-align: middle;"></i> <strong style="color: #333;"><?php echo e($phone); ?></strong> & <i class="ti ti-mail" style="color: #0073d1; font-size: 15px; vertical-align: middle;"></i> <strong id="verification-email-display" style="color: #333;"><?php echo e($email); ?></strong>
                    </p>
                </div>
            ...
            <?php else: ?>
                <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 12px 16px; margin-bottom: 18px; text-align: center;">
                    <p style="margin: 0; color: #555; font-size: 13px;">
                        Verification code sent to: <i class="ti ti-mail" style="color: #0073d1; font-size: 15px; vertical-align: middle;"></i> <strong id="verification-email-display" style="color: #333;"><?php echo e($email); ?></strong>
                    </p>
                </div>
            ...
            <!-- Back Link -->
            <div class="back-link">
                <a href="<?php echo e(route('public.account.register')); ?>">Back to Registration</a>
            </div>
        </div>
    </div>
</div>
...
(function() {
    ...
    const email = <?php echo json_encode($email, 15, 512) ?>;
    const verifyEmailCodeUrl = '<?php echo e(route("public.account.register.verifyEmailCode")); ?>';
    const sendVerificationCodeUrl = '<?php echo e(route("public.account.register.sendVerificationCode")); ?>';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        verifyBtn.addEventListener('click', function() {
            ...
            .then(data => {
                if (data.error === false) {
                    window.location.href = '<?php echo e(route("public.account.register.institutionTypePage")); ?>';
                } else {
                ...
                if (data.error === false) {
                    <?php if(!empty($isWhatsappAvailable) && !empty($phone)): ?>
                        if (typeof window.showDialogAlert === 'function') {
                            window.showDialogAlert('success', 'Verification code resent successfully to your WhatsApp (<?php echo e($phone); ?>) and Email (<?php echo e($email); ?>)!', 'Success');
                        } else {
                            showToast('text-success', 'Verification code resent successfully to your WhatsApp (<?php echo e($phone); ?>) and Email (<?php echo e($email); ?>)!');
                        }
                    <?php else: ?>
                        if (typeof window.showDialogAlert === 'function') {
                            window.showDialogAlert('success', 'Verification code resent successfully to your Email (<?php echo e($email); ?>)!', 'Success');
                        } else {
                            showToast('text-success', 'Verification code resent successfully to your Email (<?php echo e($email); ?>)!');
                        }
                    <?php endif; ?>
                    startTimer();
                } else {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/auth/verify-email.blade.php ENDPATH**/ ?>