    ...
    <div class="container">
        ...
        <div class="row">
            <div class="<?php if(JobBoardHelper::canViewCandidateInformation()): ?> col-lg-8 <?php else: ?> col-lg-12 <?php endif; ?> col-md-12">
                ...
                <div class="cdt-card">
                    <h4 class="cdt-block-heading"><?php echo e(__('Intro Video')); ?></h4>
                    <div class="cdt-yt-embed-wrap" style="position:relative;display:block;height:0;padding-bottom:56.25%;overflow:hidden;border-radius:8px;background:#000;">
                        <iframe src="<?php echo e($youtubeEmbedUrl); ?>" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <?php if(JobBoardHelper::canViewCandidateInformation()): ?>
                <div class="col-lg-4 col-md-12">
                    ...
                    <?php if(is_plugin_active('ads') && function_exists('render_page_ads')): ?>
                        <?php $sidebarAds = render_page_ads('candidate-detail', 'sidebar-right'); ?>
        ...
        <div class="cdt-summary-card">
            <div class="cdt-summary-top">
                ...
                <div>
                    <h1 class="cdt-summary-name">
                        <span><?php echo e($candidate->name ?? 'Candidate'); ?></span>
                        <?php if($candidateIsFeatured): ?>
                            <span class="badge bg-warning text-dark" style="font-size: 12px; font-weight: 700;"><?php echo e(__('Featured')); ?></span>
                        <?php endif; ?>
                    </h1>
                    <?php if(!$profileLocked && ($candidate->description ?? null)): ?>
                        <p class="cdt-summary-subtitle"><?php echo BaseHelper::clean($candidate->description); ?></p>
                    <?php elseif($profileLocked): ?>
                        <p class="cdt-summary-subtitle"><?php echo e(trans('plugins/job-board::messages.candidate_profile_locked')); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if(!$profileLocked && JobBoardHelper::canViewCandidateInformation()): ?>
                        <div class="cdt-summary-actions">
                            <?php if(isset($account) && $account && $account->isEmployer() && ($employerJobs ?? collect())->isNotEmpty()): ?>
                                <button type="button" class="cdt-btn-primary" data-bs-toggle="modal" data-bs-target="#cdtInviteToApplyModal" title="<?php echo e(__('25 credits per invite')); ?>"><i class="feather-send"></i> <?php echo e(__('Invite to Apply')); ?></button>
                            <?php endif; ?>
                            <?php if($candidate->email ?? null): ?>
                                <a href="mailto:<?php echo e($candidate->email); ?>" class="cdt-btn-primary"><i class="feather-mail"></i> <?php echo e(__('Send Email')); ?></a>
                            <?php endif; ?>
                            <?php if(($candidate->resume ?? null) && !($candidate->hide_cv ?? false)): ?>
                                <a href="<?php echo e($candidate->resume_url ?? '#'); ?>" download class="cdt-btn-outline"><i class="feather-download"></i> <?php echo e(__('Download Resume')); ?></a>
                            <?php endif; ?>
                            <?php if($candidate->phone ?? null): ?>
                                <a href="tel:<?php echo e($candidate->phone); ?>" class="cdt-btn-soft"><i class="feather-phone"></i> <?php echo e(__('Call')); ?></a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="cdt-summary-meta">
                <div class="cdt-meta-item">
                    <div class="cdt-meta-label"><?php echo e(__('Current Location')); ?></div>
                    <div class="cdt-meta-value"><?php echo e($currentLocStr ?: '—'); ?></div>
                </div>
                <div class="cdt-meta-item">
                    <div class="cdt-meta-label"><?php echo e(__('Date of Birth')); ?></div>
                    <div class="cdt-meta-value"><?php echo e($candidate->dob ? $candidate->dob->format('M d, Y') : '—'); ?></div>
                </div>
                <div class="cdt-meta-item">
                    <div class="cdt-meta-label"><?php echo e(__('Profile Created')); ?></div>
                    <div class="cdt-meta-value"><?php echo e($candidate->created_at ? $candidate->created_at->format('M d, Y') : '—'); ?></div>
                </div>
                <div class="cdt-meta-item">
                    <div class="cdt-meta-label"><?php echo e(__('Last Updated')); ?></div>
                    <div class="cdt-meta-value"><?php echo e($candidate->updated_at ? $candidate->updated_at->diffForHumans() : '—'); ?></div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="cdt-card">
                    <h4 class="cdt-block-heading"><i class="ti ti-map-pin me-2"></i><?php echo e(__('Availability and Location Preferences')); ?></h4>
                    <div class="cdt-detail-row">
                        <span class="cdt-detail-label"><?php echo e(__('Current Location')); ?></span>
                        <span class="cdt-detail-value"><?php echo e($currentLocStr ?: '—'); ?></span>
                    </div>
                </div>

                
                <div class="cdt-card">
                    <h4 class="cdt-block-heading"><i class="ti ti-info-circle me-2"></i><?php echo e(__('About')); ?></h4>
                    <?php if($candidate->bio ?? null): ?>
                        <div class="ck-content"><?php echo BaseHelper::clean($candidate->bio); ?></div>
                    <?php elseif($candidate->description ?? null): ?>
                        <div class="ck-content"><?php echo BaseHelper::clean($candidate->description); ?></div>
                    <?php else: ?>
                        <p class="cdt-empty-msg">— <?php echo e(__('No description added')); ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="cdt-card">
                    <h4 class="cdt-block-heading"><i class="ti ti-briefcase me-2"></i><?php echo e(__('Professional Information')); ?></h4>

                    
                    <div class="cdt-subcard">
                        <div class="cdt-subcard-title"><i class="ti ti-building-skyscraper"></i><?php echo e(__('Experience')); ?></div>
                        <?php if(isset($experiences) && $experiences->isNotEmpty()): ?>
                            <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="cdt-subrow">
                                    <div class="title"><?php echo e($experience->company ?? '—'); ?></div>
                                    <div class="meta">
                                        <?php echo e($experience->position ? ucwords($experience->position) : '—'); ?>

                                        <?php if($experience->started_at): ?>
                                            <span style="font-weight:700;"> (<?php echo e($experience->started_at->format('Y')); ?><?php echo e(($experience->is_current || ! $experience->ended_at) ? ' - ' . __('Present') : ' - ' . $experience->ended_at?->format('Y')); ?>)</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="cdt-subcard">
                        <div class="cdt-subcard-title"><i class="ti ti-school"></i><?php echo e(__('Education')); ?></div>
                        <?php if(isset($educations) && $educations->isNotEmpty()): ?>
                            <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="cdt-subrow">
                                    <div class="title"><?php echo e($education->school ? ucwords($education->school) : '—'); ?></div>
                                    <div class="meta">
                                        <?php echo e($education->specialized ? ucwords($education->specialized) : '—'); ?>

                                        <?php if($education->started_at): ?>
                                            <span style="font-weight:700;"> (<?php echo e($education->started_at->format('Y')); ?><?php echo e(($education->is_current || ! $education->ended_at) ? ' - ' . __('Present') : ' - ' . $education->ended_at?->format('Y')); ?>)</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/views/job-board/candidate.blade.php ENDPATH**/ ?>