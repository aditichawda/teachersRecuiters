...
<?php endif; ?>
                                ...
                                <?php if(isset($jobSeekerCtx) && $jobSeekerCtx && $jobSeekerCtx->hasPackage()): ?>
                                    ...
                                    <div class="wallet-js-coins-row">
                                        <span class="small opacity-95"><?php echo e(__('Package expires on')); ?>:</span>
                                        <span class="small ms-1">
                                            <?php if(isset($packageExpiryAt) && $packageExpiryAt): ?>
                                                <?php echo e($packageExpiryAt->format('M d, Y')); ?>
                                    ...
                                    <div class="wallet-js-coins-row">
                                        <span class="small opacity-95"><?php echo e(__('Job applications')); ?>:</span>
                                        <span class="small ms-1">
                                            <?php if($limit === null): ?>
                                                <?php echo e(__('Unlimited')); ?>

                                            <?php else: ?>
                                                <?php echo e($used); ?>/<?php echo e($limit); ?>
...
<?php $component->withAttributes(['class' => 'py-2']); ?>
                                ...
                                <button type="button" class="wallet-recharge-trigger" data-bs-toggle="modal" data-bs-target="#walletRechargeModal"><?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
...
<?php $component = $__componentOriginal73995948b3bd877b76251b40caf28170; ?>
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?><?php echo e(__('Recharge Wallet')); ?></button>
                                <div class="wallet-recharge-hint text-white"><?php echo e(__('Minimum recharge ₹100.')); ?></div>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('public.account.wallet.recharge.start')),'method' => 'post','id' => 'walletRechargeForm']); ?>
                        <div class="modal-body">
                            <p class="small text-muted mb-3 mb-0"><?php echo e(__('1 INR = 1 Coin. Minimum recharge ₹100.')); ?></p>
                            <label class="form-label fw-semibold mt-3" for="walletRechargeAmount"><?php echo e(__('Enter amount (INR)')); ?></label>
                            <input type="number" name="amount_inr" id="walletRechargeAmount" class="form-control wallet-recharge-input" min="100" step="1" value="<?php echo e(old('amount_inr', 100)); ?>" placeholder="100" required>
                ...
                if (form) {
                    form.addEventListener('submit', function (event) {
                        ...
                        if (!val || val < minAmount) {
                            ...
                            if (errorEl) {
                                errorEl.textContent = '<?php echo e(__('Minimum recharge amount is ₹100.')); ?>';
                            }
                            amountInput.focus();
                        }
                    });
