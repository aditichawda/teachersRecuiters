...
<div class="exp-form-card">
    <div class="exp-form-header">
        <h3><i class="fa fa-briefcase me-2"></i><?php echo e(__('Add Experience')); ?></h3>
        <p><?php echo e(__('Add your work experience details')); ?></p>
    </div>
    <form action="<?php echo e(route('public.account.experiences.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="company"
                           name="company" value="<?php echo e(old('company')); ?>" placeholder="<?php echo e(__('e.g. DPS School, ABC College')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" id="position"
                           name="position" value="<?php echo e(old('position')); ?>" placeholder="<?php echo e(__('e.g. Mathematics Teacher, Principal')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" name="employment_type">
                        ...
                        <?php $__currentLoopData = ['full_time' => 'Full Time', 'part_time' => 'Part Time', 'contract' => 'Contract', 'internship' => 'Internship', 'freelance' => 'Freelance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php if(old('employment_type') == $val): echo 'selected'; endif; ?>><?php echo e($lbl); ?></option>
...
unset($__errorArgs, $__bag); ?>" id="location"
                           name="location" value="<?php echo e(old('location')); ?>" placeholder="<?php echo e(__('e.g. New Delhi, Mumbai')); ?>"/>
...
unset($__errorArgs, $__bag); ?>" name="description" rows="4" placeholder="<?php echo e(__('Describe your role, responsibilities, and achievements')); ?>"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="exp-form-footer">
            ...
            <button type="submit" class="btn-save-exp">
                <i class="fa fa-save me-1"></i> <?php echo e(__('Save Experience')); ?>
...
<?php echo $__env->make(Theme::getThemeNamespace('views.job-board.account.partials.layout-settings'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/account/experiences/create.blade.php ENDPATH**/ ?>