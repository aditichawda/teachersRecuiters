...
<html <?php echo Theme::htmlAttributes(); ?>>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('themes/jobzilla/css/dialog-alert.css')); ?>?v=<?php echo e(get_cms_version()); ?>">
        
        <link rel="stylesheet" href="<?php echo e(asset('themes/jobzilla/css/blue-loader.css')); ?>?v=<?php echo e(get_cms_version()); ?>">
