...
<?php $component->withAttributes([]); ?>
            ...
            <?php if($companyLogo): ?>
                <div class="mb-4">
                    <img src="<?php echo e(RvMedia::getImageUrl($companyLogo)); ?>" alt="<?php echo e($companyName ?? 'Company'); ?>" style="max-height: 40px;">
                </div>
            <?php endif; ?>
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <p class="mb-1"><strong>Invoice Number:</strong> #<?php echo e($invoice->code); ?></p>
                    <p class="mb-1"><strong>Invoice Date:</strong> <?php echo e($invoice->created_at->translatedFormat('d M Y')); ?></p>
                </div>
                <div class="col-md-6">
                    <p class="mb-1"><strong>Payment Method:</strong> <?php echo e($paymentMethodLabel); ?></p>
                    <p class="mb-1"><strong>Transaction ID:</strong> <?php echo e($transactionId); ?></p>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::badge','data' => ['color' => 'success','class' => 'px-3 py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'success','class' => 'px-3 py-2']); ?>PAID <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php else: ?>
                    <?php if (isset($component)) { $__componentOriginal86e87e37d100cbb441f5e9e293185347 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal86e87e37d100cbb441f5e9e293185347 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::badge','data' => ['color' => 'warning','class' => 'px-3 py-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'warning','class' => 'px-3 py-2']); ?>UNPAID <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal86e87e37d100cbb441f5e9e293185347)): ?>
<?php $attributes = $__attributesOriginal86e87e37d100cbb441f5e9e293185347; ?>
<?php unset($__attributesOriginal86e87e37d100cbb441f5e9e293185347); ?>
...
<?php endif; ?>
            ...
            <div class="col-md-6">
                    ...
                    <p class="mb-1"><strong>Institution Name:</strong> <?php echo e($invoice->company_name ?: '-'); ?></p>
                    <p class="mb-1"><strong>Address:</strong> <?php echo e($invoice->customer_address ?: '-'); ?></p>
                    <?php
                        $employerGst = $invoice->customer_gst_number ?? $invoice->tax_id;
                    ?>
                    <?php if($employerGst && trim((string)$employerGst) !== ''): ?>
                        <p class="mb-1"><strong>GST No:</strong> <?php echo e($employerGst); ?></p>
                    <?php endif; ?>
                    <p class="mb-1"><strong>Phone:</strong> <?php echo e($invoice->customer_phone ?: '-'); ?></p>
                    <p class="mb-1"><strong>Email:</strong> <?php echo e($invoice->customer_email ?: '-'); ?></p>
                </div>
                <div class="col-md-6">
                    <div class="border-bottom border-2 border-dark pb-2 mb-2">
                        <strong>Our Company Details on Invoice</strong>
                    </div>
                    <p class="mb-1"><strong>Company Name:</strong> <?php echo e($companyName ?: '-'); ?></p>
                    <p class="mb-1"><strong>Address:</strong> <?php echo e($companyAddress ?: '-'); ?></p>
                    <p class="mb-1"><strong>Phone:</strong> <?php echo e($companyPhone ?: '-'); ?></p>
                    <p class="mb-1"><strong>Email:</strong> <?php echo e($companyEmail ?: '-'); ?></p>
                    <?php if(isset($companyGst)): ?>
                        <?php if(trim($companyGst) !== ''): ?>
                            <p class="mb-1"><strong>GST No :</strong> <?php echo e($companyGst); ?></p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::table.index','data' => ['class' => 'table-bordered','striped' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'table-bordered','striped' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Plan Name <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>Validity <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Plan Features <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?>Qty <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>Plan Cost <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>GST (CGST/SGST) 18% <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?>Total Amount <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56)): ?>
<?php $attributes = $__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56; ?>
<?php unset($__attributesOriginal9d47a2fcc66b3d4a341b30c8f4c9dd56); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?><?php echo e($itemValidity); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($item->description ?: '-'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-center']); ?><?php echo e($item->qty); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?><?php echo e(format_price($item->amount, $currency)); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php $component->withAttributes(['class' => 'text-end']); ?>
                                <?php if($item->tax_amount && $item->tax_amount > 0): ?>
                                    <?php echo e(format_price($item->tax_amount, $currency)); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-end']); ?><?php echo e(format_price($item->amount * $item->qty, $currency)); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
<?php $attributes = $__attributesOriginal39a228eaec73c356bdf14858f816ca38; ?>
<?php unset($__attributesOriginal39a228eaec73c356bdf14858f816ca38); ?>
...
<?php endif; ?>
                ...
                <div class="col-md-5">
                    <?php if($invoice->tax_amount > 0): ?>
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <strong><?php echo e(format_price($invoice->tax_amount, $currency)); ?></strong>
                        </div>
                    <?php endif; ?>
                    <?php if($invoice->discount_amount > 0): ?>
                        <div class="d-flex justify-content-between mb-1">
                            <span>Discount:</span>
                            <strong><?php echo e(format_price($invoice->discount_amount, $currency)); ?></strong>
                        </div>
                    <?php endif; ?>
                    <div class="d-flex justify-content-between border-top pt-2 mt-2">
                        <strong>Total Amount:</strong>
                        <strong class="text-danger"><?php echo e(format_price($invoice->amount, $currency)); ?></strong>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-5 pt-4 border-top">
                ...
                <p class="mb-1"><strong>Account Number:</strong> <?php echo e($bankAccountNumber); ?></p>
                <p class="mb-1"><strong>Account Name:</strong> <?php echo e($bankAccountName); ?></p>
                <p class="mb-1"><strong>IFSC:</strong> <?php echo e($bankIfsc); ?></p>
                <p class="mb-1"><strong>Bank Name:</strong> <?php echo e($bankName); ?></p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('public.account.invoices.generate_invoice', ['invoice' => $invoice->id, 'type' => 'print']),'target' => '_blank','icon' => 'ti ti-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('public.account.invoices.generate_invoice', ['invoice' => $invoice->id, 'type' => 'print'])),'target' => '_blank','icon' => 'ti ti-printer']); ?>
                    <?php echo e(trans('plugins/job-board::invoice.print')); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('public.account.invoices.generate_invoice', ['invoice' => $invoice->id, 'type' => 'download']),'icon' => 'ti ti-download','target' => '_blank','rel' => 'noopener','download' => 'invoice-'.e($invoice->code).'.pdf']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('public.account.invoices.generate_invoice', ['invoice' => $invoice->id, 'type' => 'download'])),'icon' => 'ti ti-download','target' => '_blank','rel' => 'noopener','download' => 'invoice-'.e($invoice->code).'.pdf']); ?>
                    <?php echo e(trans('plugins/job-board::invoice.download')); ?>
