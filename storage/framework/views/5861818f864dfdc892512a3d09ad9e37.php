        ...
        <div class="row">
                ...
                <div class="js-profile-sidebar">
                    <div class="text-center">
                        <div class="js-profile-avatar-wrapper">
                            ...
                            <a href="<?php echo e(url(route('public.account.settings'))); ?>" class="js-avatar-camera-btn" data-nav-link title="<?php echo e(__('Change Photo')); ?>">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(url(route('public.account.settings'))); ?>" class="js-view-profile-btn js-view-profile-edit" data-nav-link>
                    ...
                    <ul class="js-sidebar-nav js-account-nav-links">
                        <li><a href="<?php echo e(url(route('public.account.jobseeker.dashboard'))); ?>" class="active" data-nav-link><i class="fa fa-home"></i> Dashboard</a></li>
                        <li><a href="<?php echo e(url(route('public.account.settings'))); ?>" data-nav-link><i class="fa fa-user"></i> My Profile</a></li>
                        <li><a href="<?php echo e(url(route('public.account.jobs.saved'))); ?>" data-nav-link><i class="fa fa-bookmark"></i> Saved Jobs</a></li>
                        <li><a href="<?php echo e(url(route('public.account.jobs.applied-jobs'))); ?>" data-nav-link><i class="fa fa-file-alt"></i> Applied Jobs</a></li>
                        <li><a href="<?php echo e(url(route('public.account.experiences.index'))); ?>" data-nav-link><i class="fa fa-briefcase"></i> Experience</a></li>
                        <li><a href="<?php echo e(url(route('public.account.educations.index'))); ?>" data-nav-link><i class="fa fa-graduation-cap"></i> Education</a></li>
                        <li><a href="<?php echo e(url(route('public.account.interests-achievements'))); ?>" data-nav-link><i class="fa fa-star"></i> Interests & Achievements</a></li>
                        <li><a href="<?php if(\Botble\JobBoard\Facades\JobBoardHelper::isEnabledCreditsSystem()): ?><?php echo e(url(route('public.account.jobseeker.wallet'))); ?><?php else: ?>#<?php endif; ?>" data-nav-link><i class="fa fa-wallet"></i> <?php echo e(__('Wallet')); ?> <span style="background:#f59e0b;color:#fff;padding:1px 8px;border-radius:10px;font-size:11px;margin-left:auto;"><?php if(\Botble\JobBoard\Facades\JobBoardHelper::isEnabledCreditsSystem()): ?><?php echo e(format_credits_short($account->credits ?? 0)); ?><?php else: ?><?php echo e($walletPoints); ?><?php endif; ?></span></a></li>
                        <li><a href="<?php echo e(url(route('public.account.resume-builder'))); ?>" data-nav-link><i class="fa fa-file-pdf"></i> Resume Builder</a></li>
                        <li><a href="<?php echo e(url(route('public.account.security'))); ?>" data-nav-link><i class="fa fa-lock"></i> Security</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="js-dashboard-content">
                    ...
                    <!-- Stats Cards -->
                    <div class="js-stats-row <?php echo e(\Botble\JobBoard\Facades\JobBoardHelper::isEnabledCreditsSystem() ? 'js-stats-row-4' : ''); ?>">
                        <?php if(\Botble\JobBoard\Facades\JobBoardHelper::isEnabledCreditsSystem()): ?>
                        <a href="<?php echo e(url(route('public.account.jobseeker.wallet'))); ?>" class="js-stat-card blue text-decoration-none" data-nav-link style="color: inherit;">
                            <h6><?php echo e(__('Available Coins')); ?></h6>
                            <h2><?php echo e(format_credits_short($account->credits ?? 0)); ?></h2>
                        ...
                        <div class="js-content-card">
                            <div class="js-content-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                <?php if(count($recentApplications) > 0): ?>
                                    <a href="<?php echo e(route('public.account.jobs.applied-jobs')); ?>" class="btn btn-sm btn-outline-primary">View all</a>
                                <?php endif; ?>
                            </div>
                            <div class="js-content-card-body">
                                <?php if(count($recentApplications) > 0): ?>
                                    <?php $__currentLoopData = $recentApplications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="js-application-item border-bottom mb-3 pb-3" style="border-color: #e9ecef !important;">
                                            <div class="d-flex align-items-center js-application-toggle cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#app-detail-<?php echo e($application->id); ?>" aria-expanded="false">
                                                ...
                                                <div class="js-application-info flex-grow-1">
                                                    <h6 class="mb-0"><?php echo e($application->job->name ?? 'Job'); ?></h6>
                                                    <p class="mb-0 small text-muted">Applied <?php echo e($application->created_at->diffForHumans()); ?> · <span class="text-primary small">Click for details</span></p>
                                                </div>
                                                <i class="fa fa-chevron-down text-primary ms-2 js-application-chevron"></i>
                                            </div>
                                            <div class="collapse mt-2" id="app-detail-<?php echo e($application->id); ?>">
                                                <div class="small bg-light rounded p-3" style="border-left: 3px solid #0d6efd;">
                                                    <p class="mb-1"><strong>Name:</strong> <?php echo e($application->full_name ?: trim($application->first_name . ' ' . ($application->last_name ?? '')) ?: '—'); ?></p>
                                                    <p class="mb-1"><strong>Address:</strong> <?php echo e(optional($application->account)->address ?? '—'); ?></p>
                                                    <p class="mb-1"><strong>Mobile:</strong> <?php echo e($application->phone ?: optional($application->account)->phone ?? '—'); ?></p>
                                                    <p class="mb-0"><strong>State:</strong> <?php echo e(optional($application->account)->state_name ?? optional($application->account)->city_name ?? '—'); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div id="profileModal" class="pm-overlay" style="display:none;">
    <div class="pm-modal">
        ...
        <?php if($completion < 100): ?>
            <a href="<?php echo e(url(route('public.account.settings'))); ?>" class="pm-complete-btn" data-nav-link>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/account/dashboard.blade.php ENDPATH**/ ?>