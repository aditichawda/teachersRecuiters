...
<?php $component->withAttributes(['type' => 'info','class' => 'bg-white text-info']); ?>
                <div class="d-flex align-items-center">
                    <div>
                        <?php echo e(trans('plugins/job-board::job-category.table_view_info')); ?>

                        <a href="<?php echo e(route('job-categories.index', ['as' => 'table'])); ?>" class="text-decoration-underline">
                            <?php echo e(trans('plugins/job-board::job-category.manage_as_table')); ?>
...
<?php echo $__env->make($layout ?? BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aditi\platform\plugins\job-board\/resources/views/categories/form-tree-category.blade.php ENDPATH**/ ?>