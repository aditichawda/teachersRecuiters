...
<div class="enl-header">
    <div class="enl-header-inner">
        <!-- Logo -->
        <a href="<?php echo e(route('public.account.dashboard')); ?>" class="enl-header-logo">
            <?php if($logo = Theme::getLogo()): ?>
                <img src="<?php echo e(RvMedia::getImageUrl($logo)); ?>" alt="<?php echo e(Theme::getSiteTitle()); ?>">
            <?php else: ?>
                <strong style="font-size:18px;color:#333;"><?php echo e(Theme::getSiteTitle()); ?></strong>
            <?php endif; ?>
        </a>

        <!-- Center Nav -->
        <ul class="enl-header-nav">
            <li><a href="<?php echo e(route('public.account.dashboard')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['enl-h-active' => $currentUrl == route('public.account.dashboard')]); ?>"><i class="fa fa-home"></i> Dashboard</a></li>
            <li><a href="<?php echo e(route('public.account.jobs.create')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['enl-h-active' => $currentUrl == route('public.account.jobs.create')]); ?>"><i class="fa fa-plus-circle"></i> Post Job</a></li>
            <li><a href="<?php echo e(route('public.account.jobs.index')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['enl-h-active' => str_contains($currentUrl, '/jobs') && !str_contains($currentUrl, '/create')]); ?>"><i class="fa fa-briefcase"></i> Jobs</a></li>
            <li><a href="<?php echo e(route('public.account.applicants.index')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['enl-h-active' => str_contains($currentUrl, 'applicants')]); ?>"><i class="fa fa-users"></i> Applicants</a></li>
        </ul>

        <!-- Right -->
        <div class="enl-header-right">
            <a href="<?php echo e(url('/')); ?>" class="enl-header-home" target="_blank"><i class="fa fa-globe"></i> Homepage</a>
