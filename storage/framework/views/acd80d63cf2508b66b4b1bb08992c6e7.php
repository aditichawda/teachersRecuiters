...
<?php if($withCountryCodeSelection): ?>
    <?php if (! $__env->hasRenderedOnce('1dbbf8ac-624e-4ae8-b54d-325e485fb5fb')): $__env->markAsRenderedOnce('1dbbf8ac-624e-4ae8-b54d-325e485fb5fb'); ?>
        <?php echo $__env->make('core/base::forms.fields.phone-number-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/core/base/resources/views/forms/fields/phone-number.blade.php ENDPATH**/ ?>