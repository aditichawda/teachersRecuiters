...
<?php endif; ?>
                                ...
                                <?php if(isset($jobSeekerCtx) && $jobSeekerCtx && $jobSeekerCtx->hasPackage()): ?>
                                    ...
                                    <div class="wallet-js-coins-row">
                                        <span class="small opacity-95"><?php echo e(__('Current plan')); ?>:</span>
                                        <span class="small fw-semibold ms-1"><?php echo e($currentPlanName); ?></span>
                                    </div>
                                    <div class="wallet-js-coins-row">
                                        <span class="small opacity-95"><?php echo e(__('Validity')); ?>:</span>
...
<?php echo $__env->make(Theme::getThemeNamespace('views.job-board.account.partials.layout-settings'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/dashboard/wallet-jobseeker.blade.php ENDPATH**/ ?>