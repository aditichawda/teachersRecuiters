    ...
    <div class="institution-container">
        ...
        <div class="institution-body">
            ...
            <form id="institution-type-form" onsubmit="return false;">
                ...
                <!-- Back Link -->
                <div class="back-link">
                    <a href="<?php echo e(route('public.account.register.verifyEmailPage')); ?>">← Back</a>
                </div>
            </form>
        </div>
    </div>
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Load email
        fetch('<?php echo e(route("public.account.register.getVerificationData")); ?>', {
            method: 'GET',
        ...
        document.getElementById('continue-btn').addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("public.account.register.saveInstitutionType")); ?>', {
                method: 'POST',
                headers: {
            ...
            .then(function(data) {
                if (data.error === false) {
                    ...
                    window.location.href = '<?php echo e(route("public.account.register.locationPage")); ?>';
                } else {
                    if (typeof window.showDialogAlert === 'function') {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/auth/institution-type.blade.php ENDPATH**/ ?>