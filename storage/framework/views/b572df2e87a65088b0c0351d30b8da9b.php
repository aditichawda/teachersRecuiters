...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="security-footer">
            <button type="submit" class="btn-save-security">
                <i class="fa fa-save me-1"></i> <?php echo e(__('Update Password')); ?>
...
<?php echo $__env->make(Theme::getThemeNamespace('views.job-board.account.partials.' . ($account && $account->isEmployer() ? 'layout-employer' : 'layout-settings')), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/views/job-board/account/settings/security.blade.php ENDPATH**/ ?>