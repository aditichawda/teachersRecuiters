...
<?php $component->withAttributes([]); ?>
    ...
    <?php echo $__env->make('core/base::layouts.' . AdminAppearance::getCurrentLayout() . '.partials.after-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
     ...
     <?php $__env->slot('headerLayout', null, []); ?> 
        <?php if(!config('core.base.general.skip_license_check') && \Botble\Base\Supports\Core::make()->isSkippedLicenseReminder()): ?>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/core/base/resources/views/layouts/master.blade.php ENDPATH**/ ?>