    ...
    <div class="applied-job-card">
        <div class="applied-job-body">
            ...
            <div class="applied-job-info">
                ...
                <?php if($application->job->company): ?>
                    <p class="applied-job-company">
                        <?php if(!$application->job->hide_company): ?>
                            <a href="<?php echo e($application->job->company->url); ?>"><?php echo e($application->job->company->name); ?></a>
                        <?php else: ?>
                            <span><?php echo e($application->job->company->name); ?></span>
                        <?php endif; ?>
                    </p>
                <?php endif; ?>
                <div class="applied-job-meta">
                    ...
                    ?>
                    <span class="applied-status-badge status-<?php echo e($statusValue); ?>">
                        <i class="fa <?php echo e($statusIcon); ?>"></i>
                        <?php echo e($application->status ? $application->status->label() : __('Pending')); ?>
...
<?php echo $__env->make(Theme::getThemeNamespace('views.job-board.account.partials.layout-settings'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/account/jobs/applied.blade.php ENDPATH**/ ?>