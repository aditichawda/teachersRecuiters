    ...
    <div class="emp-section mb-4">
        ...
        <div class="emp-section-body">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label"><i class="fab fa-google text-warning"></i> <?php echo e(__('Google')); ?></label>
                    <input type="url" name="google" class="form-control" value="<?php echo e(old('google', $company->google ?? '')); ?>" placeholder="https://g.page/...">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label"><i class="fab fa-twitter text-info"></i> <?php echo e(__('Twitter')); ?></label>
                    <input type="url" name="twitter" class="form-control" value="<?php echo e(old('twitter', $company->twitter ?? '')); ?>" placeholder="https://twitter.com/...">
                </div>
                <div class="col-md-6 mb-3">
