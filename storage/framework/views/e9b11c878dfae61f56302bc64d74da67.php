            ...
            externalForm.addEventListener('submit', function(e) {
                ...
                .then(function(data) {
                    ...
                    if (isSuccess) {
                        ...
                        if (typeof Botble !== 'undefined') {
                            Botble.showError((data && data.message) ? data.message : '<?php echo e(__("Application failed. Please try again.")); ?>');
                        }
                    }
                })
                .catch(function(error) {
                    ...
                    if (typeof Botble !== 'undefined') {
                        Botble.showError(error && error.message ? error.message : '<?php echo e(__("Application failed. Please try again.")); ?>');
                    }
                });
            });
        }
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/partials/apply-modal.blade.php ENDPATH**/ ?>