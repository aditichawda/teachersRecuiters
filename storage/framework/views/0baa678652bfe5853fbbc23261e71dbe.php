<div class="twm-jobs-grid-style1">
    ...
    <div class="twm-mid-content">
        ...
        <p class="twm-job-address"><i class="feather-map-pin"></i> <?php echo e($job->location ?: 'India'); ?></p>
    ...
    <div class="twm-right-content">
        ...
        <a href="<?php echo e($job->url); ?>" class="twm-jobs-browse site-text-primary"><?php echo e(__('View Job')); ?></a>
    </div>
</div>
