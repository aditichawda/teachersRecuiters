        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <span class="jobs-hero-badge">
                    <i class="feather-briefcase"></i> <?php echo e(__('Find Your Dream Teaching Job')); ?>

                </span>
                <h1><?php echo e($page->name ?? __('Browse Jobs')); ?></h1>
                <p><?php echo e(__('Discover thousands of verified teaching opportunities across India. Filter by location, subject, experience and more.')); ?></p>
            </div>
            <div class="col-lg-5 d-none d-lg-block">
                <div class="jobs-hero-stats">
                    <div class="jobs-hero-stat">
                        <span class="stat-num">10K+</span>
                        <span class="stat-label"><?php echo e(__('Active Jobs')); ?></span>
                    </div>
                    <div class="jobs-hero-stat">
                        <span class="stat-num">5K+</span>
                        <span class="stat-label"><?php echo e(__('Schools')); ?></span>
                    </div>
                    <div class="jobs-hero-stat">
                        <span class="stat-num">50K+</span>
                        <span class="stat-label"><?php echo e(__('Teachers')); ?></span>
                    </div>
                    <div class="jobs-hero-stat">
                        <span class="stat-num">28</span>
                        <span class="stat-label"><?php echo e(__('States')); ?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="side-bar-filter">
                    ...
                    <div class="side-bar">
                        <div class="sidebar-elements search-bx">
                            ...
                            <form action="<?php echo e($page->url); ?>" method="get" id="jobs-filter-form" data-ajax-url="<?php echo e(route('public.ajax.jobs')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/themes/jobzilla/views/job-board/partials/job-page.blade.php ENDPATH**/ ?>