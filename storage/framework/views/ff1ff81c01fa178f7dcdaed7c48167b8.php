...
<section class="cd-hero">
    <div class="container">
        <div class="cd-breadcrumb">
            ...
            <span>→</span>
            <a href="<?php echo e(route('public.companies')); ?>"><?php echo e(__('Companies')); ?></a>
            <span>→</span>
...
<div class="cd-main">
    <div class="container">
        <a href="<?php echo e(route('public.companies')); ?>" class="cd-back-btn">← <?php echo e(__('Back to Companies')); ?></a>
