                ...
                <div class="row">
                        ...
                        <div class="side-bar-filter">
                            ...
                            <div class="side-bar p-0">
                                <div class="sidebar-elements search-bx">
                                    ...
                                    <form action="<?php echo e(route('public.ajax.candidates')); ?>" method="get" id="candidate-filter-form" data-ajax-url="<?php echo e(route('public.ajax.candidates')); ?>" class="p-2">
                                        
                                        <?php echo Theme::partial('candidates.filters.city'); ?>

                                        
                                        
                                        <?php echo Theme::partial('candidates.filters.experiences'); ?>

                                        
                                        
                                        <?php echo Theme::partial('candidates.filters.salary'); ?>

                                        
                                        
                                        <?php echo Theme::partial('candidates.filters.skills'); ?>

                                        
                                        <input type="hidden" name="per_page" value="<?php echo e(BaseHelper::stringify(request()->query('per_page', 12))); ?>">
                                        <input type="hidden" name="page" value="1">
                                        <input type="hidden" name="layout" value="<?php echo e(BaseHelper::stringify(request()->query('layout') ?: $shortcode->layout ?: 'grid')); ?>">
                    ...
                    <div class="col-lg-9 col-md-12 position-relative candidates-listing-modern">
                        ...
                        <div class="twm-candidates-list-wrap candidates-listing">
                            <?php echo $__env->make(Theme::getThemeNamespace('views.job-board.partials.candidates.index'), ['layout' => $layout], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/partials/shortcodes/candidates/style-1.blade.php ENDPATH**/ ?>