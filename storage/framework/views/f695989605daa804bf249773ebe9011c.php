...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'display-4 text-primary']); ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <h3 class="mb-0"><?php echo e($account->credits ?? 0); ?></h3>
                            <p class="text-muted mb-0"><?php echo e(trans('plugins/job-board::dashboard.wallet_balance')); ?></p>
                            <small class="text-muted"><?php echo e(trans('plugins/job-board::dashboard.credits')); ?></small>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-arrow-down-right'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Botble\Icon\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'display-4 text-success']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73995948b3bd877b76251b40caf28170)): ?>
<?php $attributes = $__attributesOriginal73995948b3bd877b76251b40caf28170; ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <h3 class="mb-0 text-success">+<?php echo e($totalCredit); ?></h3>
                            <p class="text-muted mb-0"><?php echo e(trans('plugins/job-board::dashboard.wallet_credit_debit_info')); ?></p>
                            <small class="text-muted"><?php echo e(trans('plugins/job-board::dashboard.wallet_credit')); ?></small>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <?php if (isset($component)) { $__componentOriginal73995948b3bd877b76251b40caf28170 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal73995948b3bd877b76251b40caf28170 = $attributes; } ?>
<?php $component = Botble\Icon\View\Components\Icon::resolve(['name' => 'ti ti-arrow-up-right'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Botble\Icon\View\Components\Icon::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'display-4 text-danger']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal73995948b3bd877b76251b40caf28170)): ?>
<?php $attributes = $__attributesOriginal73995948b3bd877b76251b40caf28170; ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <h3 class="mb-0 text-danger">-<?php echo e($totalDebit); ?></h3>
                            <p class="text-muted mb-0">&nbsp;</p>
                            <small class="text-muted"><?php echo e(trans('plugins/job-board::dashboard.wallet_debit')); ?></small>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                <?php echo e(trans('plugins/job-board::dashboard.wallet_transaction_details')); ?>
            ...
            <?php if($transactions->isNotEmpty()): ?>
                <div class="table-responsive">
                    <table class="table table-vcenter table-hover card-table mb-0">
                        <thead>
                            <tr>
                                <th><?php echo e(trans('plugins/job-board::dashboard.wallet_date')); ?></th>
                                <th><?php echo e(trans('plugins/job-board::dashboard.wallet_description')); ?></th>
                                <th class="text-end"><?php echo e(trans('plugins/job-board::dashboard.wallet_amount')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $txn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <?php if($txn->isCredit()): ?>
                                            <span class="text-success">+<?php echo e($txn->credits); ?></span>
                                        <?php else: ?>
                                            <span class="text-danger">-<?php echo e($txn->credits); ?></span>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php unset($__componentOriginal73995948b3bd877b76251b40caf28170); ?>
<?php endif; ?>
                    <p class="empty-title mt-2"><?php echo e(trans('plugins/job-board::dashboard.wallet_no_transactions')); ?></p>
                    <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','href' => route('public.account.packages'),'color' => 'primary','size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
