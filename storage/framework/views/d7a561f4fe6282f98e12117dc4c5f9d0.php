...
<div class="section-full p-t120 p-b90 site-bg-white">
    <div class="container companies">
        <div class="companies-heading">
            <h2><?php echo e(__('Schools/Institutions')); ?></h2>
            <p><?php echo e(__('Search schools in your location, apply to jobs and connect directly')); ?></p>
        </div>
    </div>
        </div>
                    ...
                    <div class="side-bar" style="padding: 0px;">
                        <div class="filter-header companies-filters-toggle" id="companies-filters-toggle">
                            ...
                            <div class="companies-filters-header-right">
                                <a href="<?php echo e(request()->url()); ?>" class="btn-clear-all">
                                    <i class="feather-x"></i>
                        ...
                        <div class="sidebar-elements search-bx companies-filters-container" id="companies-filters-container">
                            <form action="<?php echo e(request()->url()); ?>" method="get" id="companies-filter-form" data-ajax-url="<?php echo e(route('public.ajax.companies')); ?>">
                                <?php echo Theme::partial('companies.filters.institution-name'); ?>

                                <?php echo Theme::partial('companies.filters.institution-type'); ?>

                                <?php echo Theme::partial('companies.filters.location'); ?>

                                <?php echo Theme::partial('companies.filters.campus-type'); ?>

                                <?php echo Theme::partial('companies.filters.currently-hiring'); ?>

                                <?php echo Theme::partial('companies.filters.benefits-offered'); ?>

                                <?php echo Theme::partial('companies.filters.standard-level'); ?>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <!-- <a href="<?php echo e(request()->url()); ?>" class="btn-clear-filter w-100 mt-2"><?php echo e(__('Clear Filters')); ?></a> -->
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- <div class="companies-toolbar product-filter-wrap">
                    ...
                    <div class="woocommerce-ordering twm-filter-select gap-1">
                        ...
                        <?php $__currentLoopData = $orderByParams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php if(request()->query('sort_by') == $key): echo 'selected'; endif; ?>><?php echo e($value); ?></option>
                        ...
                        <?php $__currentLoopData = JobBoardHelper::getPerPageParams(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($page); ?>" <?php if(request()->query('per_page') == $page): echo 'selected'; endif; ?>><?php echo e(__('Show :number', ['number' => $page])); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                        <select class="wt-select-bar-2 selectpicker" name="layout" id="company-layout">
                            <option value="grid" <?php if($layout == 'grid'): echo 'selected'; endif; ?>><?php echo e(__('Grid')); ?></option>
                            <option value="list" <?php if($layout == 'list'): echo 'selected'; endif; ?>><?php echo e(__('List')); ?></option>
                    </select>
                    </div>
            </div> -->
...
<?php /**PATH C:\xampp\htdocs\Aditi\platform\themes/jobzilla/partials/shortcodes/companies/index.blade.php ENDPATH**/ ?>