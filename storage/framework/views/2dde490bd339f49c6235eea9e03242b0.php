    ...
    <div <?php echo Html::attributes($attributes); ?>>
        ...
        <?php endif; ?>
                <picture>
                    ...
                    <?php echo e(RvMedia::image($item->image_url, $item->name, attributes: ['style' => 'width: 100%; max-width: 100%; height: auto; min-height: 100px; max-height: 400px; object-fit: contain; display: block;'])); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/teachersRecuiters/platform/plugins/ads/resources/views/partials/ad-display.blade.php ENDPATH**/ ?>