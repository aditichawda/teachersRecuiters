...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.languages.name')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.languages.code')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.languages.level')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/job-board::account.table.languages.is_native')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($language->languageLevel->name); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e($language->is_native ? trans('core/base::base.yes') : trans('core/base::base.no')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','color' => 'primary','size' => 'sm','dataBsToggle' => 'modal','dataBsTarget' => '#edit-account-entity-modal','dataModalTitle' => trans('plugins/job-board::account.edit_language'),'dataTable' => '#languages-table','href' => route('accounts.languages.edit-modal', [$language->id, $language->account_id]),'icon' => 'ti ti-edit','iconOnly' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','color' => 'primary','size' => 'sm','data-bs-toggle' => 'modal','data-bs-target' => '#edit-account-entity-modal','data-modal-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/job-board::account.edit_language')),'data-table' => '#languages-table','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('accounts.languages.edit-modal', [$language->id, $language->account_id])),'icon' => 'ti ti-edit','icon-only' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <span data-bs-toggle="tooltip" title="<?php echo e(trans('plugins/job-board::account.action_table.delete')); ?>">
                        <?php if (isset($component)) { $__componentOriginal922f7d3260a518f4cf606eecf9669dcb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::button','data' => ['tag' => 'a','color' => 'danger','size' => 'sm','href' => route('accounts.languages.destroy', $language->id),'dataBsToggle' => 'modal','dataTable' => '#languages-table','dataBsTarget' => '#modal-confirm-delete','icon' => 'ti ti-trash','iconOnly' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','color' => 'danger','size' => 'sm','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('accounts.languages.destroy', $language->id)),'data-bs-toggle' => 'modal','data-table' => '#languages-table','data-bs-target' => '#modal-confirm-delete','icon' => 'ti ti-trash','icon-only' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal922f7d3260a518f4cf606eecf9669dcb)): ?>
<?php $attributes = $__attributesOriginal922f7d3260a518f4cf606eecf9669dcb; ?>
...
<?php $component->withAttributes(['colspan' => '6','class' => 'text-center text-muted']); ?>
                    <?php echo e(trans('plugins/job-board::account.no_languages')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Aditi\platform\plugins\job-board\/resources/views/accounts/languages.blade.php ENDPATH**/ ?>