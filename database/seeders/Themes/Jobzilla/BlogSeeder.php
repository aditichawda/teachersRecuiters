...
class BlogSeeder extends BaseSeeder
{
    ...
    {
        $this->uploadFiles('themes/jobzilla/news');
        ...
        foreach ($posts as $index => &$item) {
            $item['content'] =
                ...
                Html::tag(
                    'p',
                    Html::image(
                        RvMedia::getImageUrl('themes/jobzilla/news/' . $faker->numberBetween(1, 5) . '.jpg', 'medium'),
                        'image',
                ...
                Html::tag(
                    'p',
                    Html::image(
                        RvMedia::getImageUrl('themes/jobzilla/news/' . $faker->numberBetween(6, 10) . '.jpg', 'medium'),
                        'image',
                        ['style' => 'width: 100%', 'class' => 'image_resized']
                    )
                        ->toHtml(),
                ...
                Html::tag(
                    'p',
                    Html::image(
                        RvMedia::getImageUrl('themes/jobzilla/news/' . $faker->numberBetween(11, 14) . '.jpg', 'medium'),
                        'image',
                        ['style' => 'width: 100%', 'class' => 'image_resized']
                    )
                        ->toHtml(),
            ...
            $item['image'] = $this->filePath('themes/jobzilla/news/' . ($index + 1) . '.jpg');
        }
