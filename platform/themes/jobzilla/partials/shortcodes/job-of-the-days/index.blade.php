<div class="section-full p-t120 p-b90 site-bg-white pos-relative twm-bdr-bottom-1">
    <div class="container">
        ...
        <div class="section-content">
            <div class="twm-jobs-grid-h5-wrap">
                            ...
                            <div class="twm-jobs-st5  m-b30">
                                ...
                                <div class="twm-mid-content">
                                    <a href="{{ $job->url }}" class="twm-job-title">
                                        <h4 title="{{ $job->name }}">{{ Str::limit($job->name,30) }}</h4>
                                    </a>
                ...
                @if ($shortcode->button_name)
                <div class="text-center m-b30">
                    <a href="{{ JobBoardHelper::getJobCategoriesPageURL() }}" class="site-button">{{ $shortcode->button_name }}</a>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="twm-bg-shape5-left" style="background-image: url({{ RvMedia::getImageUrl($shortcode->bg_image) }});"></div>
    @endif
</div>
