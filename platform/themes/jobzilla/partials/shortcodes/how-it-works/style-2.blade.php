    ...
    <div class="container">
        ...
        <div id="educators-content-home-section" class="hiw-content-section active">
            <div class="hiw-content-header">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('public.account.register') }}" class="hiw-step-card hiw-step-card-link" aria-label="Upload your resume - Register as Job Seeker">
        ...
        <div id="institutions-content-home-section" class="hiw-content-section">
            <div class="hiw-content-header">
                ...
                <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('public.account.register.employer') }}" class="hiw-step-card hiw-step-card-link" aria-label="Register your institution - Employer registration">
                        <span class="hiw-step-number">01</span>
