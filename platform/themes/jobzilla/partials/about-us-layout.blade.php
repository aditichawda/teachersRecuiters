        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="hiw-hero-images">
                    <img src="{{ Theme::asset()->url('/images/about-us.png') }}" alt="Teachers Recruiter" class="img-fluid rounded-4">
                </div>
            </div>
        </div>
    </div>
...
<section class="hiw-alternating-section">
    <div class="container">
        ...
        <div class="row align-items-center hiw-alt-row">
            <div class="col-lg-6">
                <div class="hiw-alt-image">
                    <img src="{{ Theme::asset()->url('/images/Connecting_Teachers.png') }}" alt="For Teachers" class="img-fluid rounded-4">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row align-items-center hiw-alt-row flex-lg-row-reverse">
            <div class="col-lg-6">
                <div class="hiw-alt-image">
                    <img src="{{ Theme::asset()->url('/images/Supporting_Schools.png') }}" alt="For Schools" class="img-fluid rounded-4">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="hiw-alt-content justify-content-center">
