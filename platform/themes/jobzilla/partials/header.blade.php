...
<html {!! Theme::htmlAttributes() !!}>
    <head>
        ...
        {{-- Dialog Alert CSS --}}
        <link rel="stylesheet" href="{{ asset('themes/jobzilla/css/dialog-alert.css') }}?v={{ get_cms_version() }}">
        {{-- Blue Loader CSS --}}
        <link rel="stylesheet" href="{{ asset('themes/jobzilla/css/blue-loader.css') }}?v={{ get_cms_version() }}">
