...
<div class="hiw-mobile-reorder-wrap">
{{-- HOW IT WORK SECTION - HOME PAGE USING SAME LAYOUT AS /how-it-works --}}
<section class="hiw-process-section hiw-process-mobile-order">
    <div class="container">
...
{{-- Video Section --}}
<section class="hiw-video-section hiw-video-mobile-order">
    <div class="container">
        <div class="hiw-section-header">
            <h2 class="hiw-section-title mt-4">See How It Works</h2>
        </div>
...
@media (max-width: 767px) {
    .hiw-mobile-reorder-wrap {
        display: flex;
        flex-direction: column;
    }

    .hiw-mobile-reorder-wrap .hiw-video-mobile-order {
        order: 1;
    }

    .hiw-mobile-reorder-wrap .hiw-process-mobile-order {
        order: 2;
    }
}
</style>
