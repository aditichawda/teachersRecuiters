...
<section class="faq-section">
    <div class="container">
        <div class="faq-header">
            ...
            <p>{{ __('Find answers to common questions about Teachers Recruiter') }}</p>
        </div>
        ...
        @else
            <div class="text-center" style="padding: 40px 0;">
                <p style="color: #94a3b8;">{{ __('No FAQs available at the moment.') }}</p>
            </div>
        @endif

        <div class="faq-contact">
            <h3>{{ __('Still have questions?') }}</h3>
            <p>{{ __('Can\'t find what you\'re looking for? Feel free to reach out to our support team.') }}</p>
