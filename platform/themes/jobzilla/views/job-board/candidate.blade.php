...
<section class="cdt-hero">
    <div class="container">
        <div class="cdt-breadcrumb">
            <a href="/">{{ __('Home') }}</a>
            <span>→</span>
            <span style="color: #475569;">{{ Str::limit($candidate->name, 40) }}</span>
        </div>
            ...
            <div class="cdt-hero-info">
                ...
                @if (JobBoardHelper::canViewCandidateInformation())
                    <div class="cdt-hero-actions">
                        @if ($candidate->phone)
                            <a href="tel:{{ $candidate->phone }}" class="cdt-btn-primary">
                                <i class="feather-phone"></i> {{ __('Hire Me Now') }}
                            </a>
                        @endif
                        @if (!$candidate->hide_cv && $candidate->resume)
                            <a href="{{ $candidate->resume_url }}" download class="cdt-btn-outline">
                                <i class="feather-download"></i> {{ __('Download CV') }}
                            </a>
                        @endif
                    </div>
                @endif
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="@if (JobBoardHelper::canViewCandidateInformation()) col-lg-8 @else col-lg-12 @endif col-md-12">
                ...
                @if ($candidate->bio)
                    <div class="cdt-card">
                        <h4 class="cdt-section-title">{{ __('About Me') }}</h4>
                ...
                @if ($experiences->isNotEmpty())
                    <div class="cdt-card">
                        <h4 class="cdt-section-title">{{ __('Work Experience') }}</h4>
                            ...
                            @foreach ($experiences as $experience)
                                <div class="cdt-timeline-item">
                                    ...
                                    @if ($experience->position)
                                        <div class="cdt-timeline-subtitle">{{ $experience->position }}</div>
                                    @endif
                ...
                @if ($educations->isNotEmpty())
                    <div class="cdt-card">
                        <h4 class="cdt-section-title">{{ __('Education & Training') }}</h4>
                        <div class="cdt-timeline">
                            @foreach ($educations as $education)
                                <div class="cdt-timeline-item">
                                    ...
                                    @if ($education->school)
                                        <div class="cdt-timeline-title">{{ $education->school }}</div>
                                    @endif
                                    @if ($education->specialized)
                                        <div class="cdt-timeline-subtitle">{{ $education->specialized }}</div>
                                    @endif
                        ...
                        <ul class="cdt-info-list">
                            @if ($candidate->gender)
                                <li>
                                    ...
                                    <div class="cdt-info-text">
                                        <div class="cdt-info-label">{{ __('Gender') }}</div>
                                        <div class="cdt-info-value">{{ ucfirst($candidate->gender) }}</div>
                                    </div>
                                </li>
                            @endif
                            @if ($candidate->phone)
                                <li>
                                    ...
                                    <div class="cdt-info-text">
                                        <div class="cdt-info-label">{{ __('Phone') }}</div>
                                        <div class="cdt-info-value">{{ $candidate->phone }}</div>
                                    </div>
                                </li>
                            @endif
                            @if ($candidate->email)
                                <li>
                                    ...
                                    <div class="cdt-info-text">
                                        <div class="cdt-info-label">{{ __('Email') }}</div>
                                        <div class="cdt-info-value">{{ $candidate->email }}</div>
                                    </div>
                                </li>
                            @endif
                            @if ($candidate->address)
                                <li>
                                    ...
                                    <div class="cdt-info-text">
                                        <div class="cdt-info-label">{{ __('Address') }}</div>
                                        <div class="cdt-info-value">{{ $candidate->address }}</div>
                                    </div>
                                </li>
                            @endif
                        </ul>
