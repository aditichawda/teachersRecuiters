                    ...
                    <div class="twm-job-self-top">
                        ...
                        <div class="twm-mid-content">
                            ...
                            <div class="twm-job-self-mid">
                                ...
                                @if ($job->displayClosingOrExpiryDate())
                                    <div class="twm-job-apllication-area">{{ $job->displayClosingOrExpiryDateLabel() }}:
                                        <span class="twm-job-apllication-date">{{ Theme::formatDate($job->displayClosingOrExpiryDate()) }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
