            ...
            <div class="signup-login-card-row">
                ...
                <div class="modal-header border-0 pb-0 pt-4 px-4 position-relative">
                    <h5 class="modal-title w-100 text-center" id="signupLoginModalLabel">
                        <span class="d-block signup-login-welcome mb-1">{{ __('Welcome') }}</span>
                        <span class="d-block signup-login-title">{{ __('Sign up or Login') }}</span>
                    </h5>
                ...
                <div class="modal-body px-4 pb-4 pt-2">
                    ...
                    <div class="form-check d-flex justify-content-center align-items-center mt-3 pt-2">
                        ...
                        <label class="form-check-label signup-login-dont-show" for="signupLoginDontShowAgain">{{ __("Don't show this popup again") }}</label>
                    </div>
                </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var showOnHomeOnly = {{ request()->is('/') ? 'true' : 'false' }};
    setTimeout(function() {
        try {
