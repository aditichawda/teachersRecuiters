...
<form id="employer-profile-form" action="{{ route('public.account.employer.settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    @php
        ...
        $instTypes = array_map(function ($v) {
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="institution_type[]" id="institution_type" class="form-select" multiple required>
                        @include(Theme::getThemeNamespace('views.job-board.partials.institution-type-select-optgroups'), [
                            'institutionTypeGroups' => $institutionTypeGroups,
                            'selectedValues' => $instTypes,
                            'selectedValue' => null,
                        ])
                    </select>
                </div>
