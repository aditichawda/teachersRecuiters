...
@section('content')
    <div class="container">
        <h3 class="title-form-education text-primary">{{ __('Edit experience') }}</h3>
        <form class="mt-3" action="{{ route('public.account.experiences.update', $experience->id) }}" method="post">
            <div class="row">
                <div class="col-12">
                    @csrf
