...
@endphp
<style>
    /* Resume Preview (Modern) responsive fixes (mobile modal) */
    .rb-resume-modern {
        box-sizing: border-box;
        width: 100%;
        max-width: 900px;
    }
    .rb-resume-modern * { box-sizing: border-box; }
    .rb-resume-modern-sidebar { flex: 0 0 280px; }
    ...
    @media (max-width: 576px) {
        ...
        .rb-resume-modern-sidebar {
            width: 100% !important;
            min-width: 0 !important;
            padding: 24px 18px !important;
        }
        .rb-resume-modern-content {
            padding: 24px 18px !important;
        }
    }
</style>

<div class="rb-resume-modern" style="font-family: 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; max-width: 900px; margin: 0 auto; display: flex; background: #fff; min-height: 920px; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
    <!-- Left Sidebar -->
    <div class="rb-resume-modern-sidebar" style="width: 280px; min-width: 280px; background: linear-gradient(180deg, #0d47a1 0%, #1565c0 50%, #1976d2 100%); color: #fff; padding: 40px 24px;">
        <!-- Avatar & Name -->
    ...
    <!-- Right Content -->
    <div class="rb-resume-modern-content" style="flex: 1; padding: 40px 36px;">
