    ...
    <div class="rb-template-card selected" data-template="classic" onclick="selectTemplate(this)">
        <div class="rb-template-preview">
            <div class="preview-inner">
                @include(Theme::getThemeNamespace('views.job-board.account.resume-templates.classic'), ['account' => $account, 'educations' => $educations, 'experiences' => $experiences, 'skills' => $skills])
            </div>
...
<div class="rb-actions">
    <div class="rb-actions-left">
        ...
        <span>{{ __('Selected:') }} <span class="rb-selected-name" id="selected-template-name">Classic</span></span>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-file-pdf me-2"></i>{{ __('Resume Preview') }}</h5>
    ...
    fetch(url)
        ...
        .then(html => {
            ...
            printWindow.document.write(`
                ...
                <html>
                <head>
                    <title>{{ $account->name }} - Resume</title>
                    <style>
                        @media print {
                            body { margin: 0; }
