@php
    ...
    $companyCount = $account->companies()->count();
                ...
                <div class="emp-profile-sidebar">
                    ...
                    <ul class="emp-sidebar-nav">
                        ...
                        @if(!$isConsultancy)
                            ...
                            <li>
                                <a
                                    href="{{ $companyCount < 1 ? route('public.account.companies.create') : route('public.account.companies.index') }}"
                                    @class(['active' => str_contains($currentUrl, 'companies'), 'emp-nav-locked' => $companyCount < 1])
                                    title="{{ $companyCount < 1 ? trans('plugins/job-board::messages.wallet_additional_profile_locked_hint') : '' }}"
                                >
                                    @if($companyCount < 1)
                                        <span class="emp-nav-lock-icon"><i class="fa fa-lock"></i></span>
                                    @endif
                                    <i class="fa fa-university"></i> {{ __('Institution') }}
                                </a>
                            </li>
                        @endif
