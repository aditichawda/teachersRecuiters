...
<section class="notifications-section">
    <div class="container">
        <div class="notifications-header">
            ...
            <p>{{ __('Stay updated with your job applications and opportunities') }}</p>
        </div>
            ...
            <div class="notifications-list">
                    ...
                    @foreach($notifications as $notification)
                        <div class="notification-item {{ !$notification['read'] ? 'unread' : '' }}" 
                            ...
                            <div class="notification-icon" 
                                 style="background: linear-gradient(135deg, {{ $notification['color'] }} 0%, {{ $notification['color'] }}dd 100%); 
                                        --icon-color: {{ $notification['color'] }};
                                        --icon-color-dark: {{ $notification['color'] }}dd;
                                        box-shadow: 0 8px 20px {{ $notification['color'] }}40;">
                            ...
                            <div class="notification-actions">
                                @if(!$notification['read'])
                                    <button class="notification-action-btn mark-read-btn" 
                                        ...
                                        <span class="action-text">{{ __('Mark as Read') }}</span>
                                    </button>
                                @endif
                                <button class="notification-action-btn delete-btn" 
                                    ...
                                    <span class="action-text">{{ __('Delete') }}</span>
                                </button>
                            </div>
                        </div>
                    @endforeach
                @else
                    <div class="empty-notifications">
                        ...
                        <p>{{ __('You are all caught up! New notifications will appear here.') }}</p>
                    </div>
                @endif
            </div>
        </div>
