    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme): void {
            ...
            // Stable asset version for browser caching (avoid first-load FOUC)
            ...
            // Important: load style.css in HEAD, not footer (prevents unstyled first paint)
            $theme->asset()->usePath()->add('style', 'css/style.css', ['main'], [], $version);
