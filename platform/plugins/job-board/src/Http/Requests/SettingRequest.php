    ...
    public function rules(): array
    {
        ...
        if ($account && $account->isJobSeeker()) {
            $rules = array_merge($rules, [
                ...
                'introductory_audio' => 'nullable|file|mimes:amr,wav,ogg,m4a,webm,mp3,mpeg,mpga|mimetypes:audio/amr,audio/3gpp,audio/amr-wb,audio/mp4,audio/mpeg,audio/mp3,audio/x-m4a,audio/m4a,audio/wav,audio/ogg,audio/webm|max:1536',
