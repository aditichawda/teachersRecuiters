...
class InvoiceSettingRequest extends Request
{
    public function rules(): array
    {
        return [
            ...
            'job_board_company_gst_for_invoicing' => ['nullable', 'string', 'max:50'],
            'job_board_bank_account_number' => ['nullable', 'string', 'max:50'],
            'job_board_bank_account_name' => ['nullable', 'string', 'max:120'],
            'job_board_bank_ifsc' => ['nullable', 'string', 'max:20'],
            'job_board_bank_name' => ['nullable', 'string', 'max:120'],
