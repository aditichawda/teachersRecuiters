...
class AccountJobRequest extends JobRequest
{
    public function rules(): array
    {
        ...
        return array_merge($rules, [
            ...
            'application_location_type' => ['nullable', 'in:nearby,specific,anywhere,across_india'],
            'application_locations' => ['nullable', 'string'],
            'hiring_institution_type' => ['nullable', 'string', 'max:100'],
            'hiring_school_name' => ['nullable', 'string', 'max:255'],
            'hide_hiring_school_name' => ['nullable', 'boolean'],
            ...
            'job_screening_questions.*.id' => ['nullable', 'integer'],
            'job_screening_questions.*.question' => ['nullable', 'string', 'max:2000'],
            'job_screening_questions.*.question_type' => ['nullable', 'string', 'in:text,textarea,dropdown,checkbox'],
