...
return [
    ...
    'templates' => [
        ...
        'job-seeker-job-alert' => [
            ...
            'variables' => [
                'account_name' => 'plugins/job-board::email.variables.account_name',
                'alert_name' => 'plugins/job-board::email.variables.alert_name',
                'job_name' => 'plugins/job-board::email.variables.job_name',
                'job_url' => 'plugins/job-board::email.variables.job_url',
                'job_description' => 'plugins/job-board::email.variables.job_description',
                'company_name' => 'plugins/job-board::email.variables.company_name',
                'job_area' => 'plugins/job-board::email.variables.job_area',
                'job_type' => 'plugins/job-board::email.variables.job_type',
                'location' => 'plugins/job-board::email.variables.location',
                'salary_range' => 'plugins/job-board::email.variables.salary_range',
                'view_jobs_url' => 'plugins/job-board::email.variables.view_jobs_url',
                'unsubscribe_url' => 'plugins/job-board::email.variables.unsubscribe_url',
            ],
        ],
        'job-alert-notification' => [
            'title' => 'plugins/job-board::email.templates.job-alert-notification.title',
            'description' => 'plugins/job-board::email.templates.job-alert-notification.description',
            'subject' => 'plugins/job-board::email.templates.job-alert-notification.subject',
            'can_off' => true,
            'variables' => [
                'account_name' => 'plugins/job-board::email.variables.account_name',
                'alert_name' => 'plugins/job-board::email.variables.alert_name',
