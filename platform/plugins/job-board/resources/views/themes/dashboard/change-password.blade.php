        ...
        <div class="cp-body">
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    <label class="form-label">{{ __('Current Password') }} <span class="required">*</span></label>
                    <div class="password-field-wrapper">
                        <input class="form-control @if ($errors->has('old_password')) is-invalid @endif" 
                               type="password" 
                ...
                <div class="col-lg-6 mb-3">
                    <label class="form-label">{{ __('New Password') }} <span class="required">*</span></label>
                    <div class="password-field-wrapper">
                ...
                <div class="col-lg-6 mb-3">
                    <label class="form-label">{{ __('Confirm New Password') }} <span class="required">*</span></label>
                    <div class="password-field-wrapper">
