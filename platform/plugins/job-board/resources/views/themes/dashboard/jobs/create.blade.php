...
<form id="jobPostForm" method="POST" action="{{ route('public.account.jobs.store') }}" enctype="multipart/form-data" data-can-post="{{ $canPost ? '1' : '0' }}">
    ...
    <div class="jp-card">
        ...
        <div class="jp-group">
            ...
            <textarea name="content" id="job_description" class="jp-textarea" rows="6" placeholder="Enter detailed job description or use AI to generate..." required>{{ isset($job) ? strip_tags($job->content) : '' }}</textarea>
