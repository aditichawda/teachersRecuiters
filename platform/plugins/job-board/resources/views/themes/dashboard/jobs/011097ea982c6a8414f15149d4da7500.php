...
<div class="rb-templates-grid">
    ...
    ?>
    <div class="rb-template-card <?php echo e($modernLocked ? 'rb-template-locked' : ''); ?>" data-template="modern" data-locked="<?php echo e($modernLocked ? '1' : '0'); ?>" onclick="selectTemplate(this)">
        <?php if($modernLocked): ?>
            <div class="rb-locked-overlay">
                <i class="fa fa-lock"></i>
                <span><?php echo e(__('Advance CV')); ?></span>
                <a href="<?php echo e($upgradeUrl); ?>" class="btn btn-sm btn-primary mt-2"><?php echo e(__('Upgrade')); ?></a>
            </div>
        <?php endif; ?>
        <div class="rb-template-preview">
            <div class="preview-inner">
        ...
        <div class="rb-template-info">
            <h5><?php echo e(__('Modern')); ?> <?php if($modernLocked): ?><span class="badge bg-secondary ms-1" style="font-size: 10px;"><?php echo e(__('Upgrade')); ?></span><?php endif; ?></h5>
            <p><?php echo e(__('Two-column design with sidebar. Profile details and dummy text when fields are empty.')); ?></p>
            <div class="rb-template-tags">
                <?php if(!$modernLocked): ?><span class="rb-template-tag tag-free">Free</span><?php endif; ?>
...
function downloadResume() {
    <?php if(($jobSeekerCtx ?? null) && !($jobSeekerCtx->hasAdvanceCv())): ?>
    if (selectedTemplate === 'modern') {
        window.location.href = '<?php echo e($jobSeekerCtx->packagesUrl()); ?>';
        return;
    }
    <?php endif; ?>
    const url = '<?php echo e(route("public.account.resume-builder.download")); ?>?template=' + selectedTemplate;
