                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        @if($item->banner_image)
                            <div class="mb-2">
                                <img src="{{ $item->banner_image }}" alt="" class="rounded border" style="max-width:100%;max-height:200px;object-fit:contain;">
                            </div>
                            <a href="{{ $item->banner_image }}" target="_blank" rel="noopener" class="small">{{ __('Open image') }}</a>
                        @else
