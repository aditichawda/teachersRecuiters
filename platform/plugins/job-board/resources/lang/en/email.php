...
return [
    ...
    'email_templates' => [
        ...
        'job_alert_message' => 'Here are some new job opportunities matching your ":alert_name" alert:',
        'job_alert_job_title' => 'Job Title: :job_name',
        'job_alert_company' => 'Company: :company_name',
        'job_alert_location' => 'Location: :location',
        'job_alert_salary' => 'Salary: :salary_range',
        'job_alert_job_type' => 'Job Type: :job_type',
        'job_alert_job_area' => 'Job Area: :job_area',
        'job_alert_description' => 'Description: :job_description',
        'job_alert_view_job_button' => 'View Job',
        'job_alert_view_all_jobs_button' => 'View All Matching Jobs',
        'job_alert_unsubscribe' => 'If you no longer wish to receive these alerts, you can <a href=":unsubscribe_url">unsubscribe here</a>.',
        'job_alert_regards' => 'Regards,',
